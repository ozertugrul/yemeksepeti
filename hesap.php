            ...
            <div class="u-form u-form-1">
                <form action="https://forms.nicepagesrv.com/v2/form/process"
                    ...
                    <div class="u-form-group u-form-group-3">
                        ...
                        <input type="number" placeholder="" id="text-de91" name="text"
                            class="u-input u-input-rectangle">
                    </div>
                    <div class="u-form-group u-form-group-4">
                        <label for="text-cd7d" class="u-label">Doğum Tarihi</label>
                        <input type="date" placeholder="" id="text-cd7d" name="text-1"
                            class="u-input u-input-rectangle">
                    </div>
            ...
            <div class="u-form u-form-3">
                <form action="https://forms.nicepagesrv.com/v2/form/process"
                    ...
                    <div class="u-form-group u-form-name">
                        ...
                        <input type="text" placeholder="Mevcut Şifre" id="name-277c" name="name"
                            class="u-input u-input-rectangle" required="">
                    </div>
                    <div class="u-form-email u-form-group">
                        <label for="email-277c" class="u-form-control-hidden u-label"></label>
                        <input type="text" placeholder="Yeni Şifre" id="email-277c" name="email"
                            class="u-input u-input-rectangle" required="">
                    </div>
