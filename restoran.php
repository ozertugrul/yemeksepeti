...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
  ...
  <body style="background-color: #333; color: #fff" data-path-to-root="./" data-include-products="false" class="u-body u-xl-mode" data-lang="tr">
    <header style="background-color: #242424" class="u-box-shadow u-clearfix u-header u-header" id="sec-68d1">
          ...
          <div class="menu-collapse" style="font-size: 1rem; letter-spacing: 0px;">
            <a class="u-button-style u-custom-left-right-menu-spacing u-custom-padding-bottom u-custom-text-active-color u-custom-text-hover-color u-custom-top-bottom-menu-spacing u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base"
              ...
              <svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 55 55">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-070d"></use>
              </svg>
              <svg class="u-svg-content" viewBox="0 0 55 55" x="0px" y="0px" id="svg-070d"
          ...
          if ($sonuc) {
            ...
            <div class="u-custom-menu u-nav-container">
              <ul class="u-nav u-unstyled u-nav-1">
                <li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-black u-text-hover-palette-2-base"
                    style="padding: 10px 20px;">
                    <?php echo $adimiz; ?>
                  </a>
                  <div class="u-nav-popup">
                    <ul class="u-h-spacing-20 u-nav u-unstyled u-v-spacing-10">
                      <li class="u-nav-item"><a class="u-button-style u-nav-link u-white" href="order.php">Siparişlerim</a>
                      </li>
                      <li class="u-nav-item"><a class="u-button-style u-nav-link u-white" href="hesap.php">Hesabım</a>
                      </li>
                      <li class="u-nav-item"><a class="u-button-style u-nav-link u-white" href="#">Yardım Merkezi</a>
                      </li>
                      <li class="u-nav-item"><a class="u-button-style u-nav-link u-white" href="logout.php">Çıkış Yap</a>
                      </li>
                    </ul>
                  </div>
                          ...
                          <li class="u-nav-item"><a class="u-button-style u-nav-link">
                            ...
                            <div class="u-nav-popup">
                              <ul class="u-h-spacing-20 u-nav u-radius u-unstyled u-v-spacing-10 u-nav-4">
                                <li class="u-nav-item"><a class="u-button-style u-nav-link" href="order.php">Siparişlerim</a>
                                </li>
                                <li class="u-nav-item"><a class="u-button-style u-nav-link" href="hesap.php">Hesabım</a>
                                </li>
                                <li class="u-nav-item"><a class="u-button-style u-nav-link" href="#">Yardım Merkezi</a>
                                </li>
                                <li class="u-nav-item"><a class="u-button-style u-nav-link" href="logout.php">Çıkış Yap</a>
                                </li>
                              </ul>
                            </div>
                          </li>
