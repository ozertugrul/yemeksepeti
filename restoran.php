...
if ($sonuc) {
          ...
          <div class="u-custom-menu u-nav-container-collapse">
            <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
              <div class="u-inner-container-layout u-sidenav-overflow">
                ...
                <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-3"><li class="u-nav-item"><a class="u-button-style u-nav-link"><?php echo $adimiz; ?></a><div class="u-nav-popup"><ul class="u-h-spacing-20 u-nav u-radius u-unstyled u-v-spacing-10 u-nav-4"><li class="u-nav-item"><a class="u-button-style u-nav-link" href="#">Siparişlerim</a>
    ...
    <section class="u-align-center u-clearfix u-container-align-left-lg u-container-align-left-xl u-image u-image-contain u-shading u-section-1" id="sec-8d47" data-image-width="1264" data-image-height="842">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h3 class="u-align-left u-text u-text-default u-text-1"><?php echo($selectedCity) ?> Online Siparişi</h3>
        <h4 class="u-align-left u-text u-text-default-lg u-text-default-xl u-text-2"> Merhaba <?php echo $adimiz; ?>, sipariş vermek için hemen bir restoran seç!</h4>
      </div>
    </section>
    <?php } 
        ?>
    <section class="u-clearfix u-section-2" id="sec-2238">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h5 class="u-text u-text-default u-text-1"><a style="color:#cd0048 !important;" href="sehirsec.php">Şehirler&nbsp;&nbsp; </a> &gt; &nbsp;&nbsp;<?php echo($selectedCity) ?></h5>
        ...
        <div class="u-border-1 u-border-grey-75 u-container-style u-list-item u-radius u-repeater-item u-shape-round u-list-item-1">
            <div class="u-container-layout u-similar-container u-valign-top-lg u-valign-top-md u-valign-top-sm u-valign-top-xs u-container-layout-1">
                <img class="u-expanded-width u-image u-image-round u-radius u-image-1" src="admin/<?php echo $DukkanResim; ?>" alt="" data-image-width="400" data-image-height="225">
                <h5 class="u-align-left u-text u-text-default u-text-3"><?php echo $RestoranAdi; ?></h5>
                <h6 class="u-align-left u-text u-text-default u-text-4"><?php echo $Minsepet; ?>₺ min sepet tutarı</h6>
            </div>
        </div>
        </a>
      <?php
